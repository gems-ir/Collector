use iced::widget::{button, container, progress_bar, row, text, Column, Space};
use iced::{Alignment, Element, Length};

use crate::gui::message::Message;
use crate::gui::{CollectionState, CollectorApp};
use crate::style::icons::{self, icon_button, icon_small};
use crate::style::theme::{icon_button_style, primary_button_style, progress_bar_style, status_bar_style};
...
pub fn view_footer(app: &CollectorApp) -> Element<'_, Message> {
    ...
    let progress_section: Element<'_, Message> = if app.collection_state == CollectionState::Collecting {
